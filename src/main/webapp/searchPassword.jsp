		...
		<div class="row align-items-md-stretch   text-center">
			<div class="row justify-content-center align-items-center">
				<div class="h-100 p-5 col-md-6">
					...
					<!-- 아이디와 전화번호로 본인인증 후 비밀번호 교체 -->
			        <form class="form-signin" action="processSearchPassword.jsp" method="post">
   			 		<!-- 아이디와 전화번호가 일치하면 아이디를 알려주는 processSearchPassword.jsp -->
			            <div class="mb-4">
		                    <!-- 아이디 입력란 -->
			            ...
			            <button type="submit" class="btn btn-lg btn-success w-100">비밀번호 찾기</button>
			        </form>
