...
<div class="container-fluid p-0 text-center" style="margin-top: 80px; position: relative;">
  <img src="./resources/img/BEAUTY09.jpg" class="img-fluid mx-auto" alt="Main Banner" style="width: 1400px; height: 600px;">
...
<div class="container pt-5 pb-3" style="margin-bottom: 30px;">
  <%
    List<Cosmetics> allCosmetics = (List<Cosmetics>) request.getAttribute("cosmeticsList");
  ...
  %>
    <div class="container pt-5 pb-3">
      <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="cosmetics?action=category&category=<%= categoryName %>" class="btn btn-sm btn-outline-secondary">
          더보기(More)
        </a>
      </div>
